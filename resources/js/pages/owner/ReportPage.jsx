    ...
    const exportCurrentReport = () => {
        ...
        win.document.write(`<html><head><title>${tab} Report</title><style>
            *{margin:0;padding:0;box-sizing:border-box;}
            ...
            .stat{display:inline-block;margin-right:16px;margin-bottom:12px;}
            .stat .lbl{font-size:11px;color:#999;} .stat .val{font-size:18px;font-weight:700;}
            table{width:100%;border-collapse:collapse;margin-top:8px;}
            td,th{padding:8px;border-bottom:1px solid #eee;text-align:left;font-size:12px;}
            th{background:#f5f5f5;} .footer{position:fixed;bottom:0;left:0;right:0;text-align:center;font-size:10px;color:#94a3b8;padding:10px;border-top:1px solid #e2e8f0;}
        </style></head><body>
            <div class="brand-banner"><div class="t">${tab} Report<small>Period: ${reportData?.date_from || 'N/A'} → ${reportData?.date_to || 'N/A'} · Generated: ${new Date().toLocaleString()}</small></div><div class="doc">${tab.replace(/_/g, ' ').toUpperCase()}</div></div>
            ...
            <script>document.addEventListener('DOMContentLoaded',init);function init(){
                ...
                src.querySelectorAll('input,select,button,svg,svg *').forEach(function(b){b.remove()});
