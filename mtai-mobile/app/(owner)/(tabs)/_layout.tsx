  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Manage',
          tabBarIcon: ({ focused }) => <TabIcon icon="grid-view" focused={focused} />,
        }}
      />
      <Tabs.Screen
        name="orders"
        options={{
          title: 'Order',
          tabBarIcon: ({ focused }) => <TabIcon icon="receipt-long" focused={focused} />,
        }}
      />
      <Tabs.Screen
        name="reports"
        options={{
          title: 'Report',
          tabBarIcon: ({ focused }) => <TabIcon icon="bar-chart" focused={focused} />,
        }}
      />
      <Tabs.Screen
        name="profile"
